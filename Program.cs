...
namespace Post
{
    // Abstract class representing a generic mail item
    public abstract class Mail
    {
        ...
        // Abstract method to calculate the postage stamp amount
        public abstract double CalculateStampAmount();

        // Method to check if the mail item is valid
        public bool IsValid()
        {
            return !string.IsNullOrEmpty(DestinationAddress);
        }

        // Method to check if the mail item is express
        public bool GetIsExpress()
        {
            return IsExpress;
        }

        // Method to get the destination address of the mail item
    ...
    // Class representing a letter mail item
    public class Letter : Mail
    {
        ...
        // Override method to calculate the postage stamp amount for a letter
        ...
        // Method to get the format of the letter
    ...
    // Class representing a parcel mail item
    public class Parcel : Mail
    {
        ...
        // Override method to calculate the postage stamp amount for a parcel
        public override double CalculateStampAmount()
        {
    ...
    // Class representing an advertisement mail item
    public class Advertisement : Mail
    {
        ...
        // Override method to calculate the postage stamp amount for an advertisement
        public override double CalculateStampAmount()
        {
    ...
    public class Box
    {
        ...
        // Method to add a mail item to the mailbox
        ...
        // Method to calculate the total postage stamp amount for all mail items in the mailbox
        public double Stamp()
        {
